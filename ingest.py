...
raw_yellow.to_csv('data/yellow_trips_raw.csv') # write to csv
...
vendor.to_csv('data/vendors.csv') # write to csv
...
rate_codes.to_csv('data/rate_codes.csv') # write to csv
...
payment.to_csv('data/payment.csv') # write to csv
